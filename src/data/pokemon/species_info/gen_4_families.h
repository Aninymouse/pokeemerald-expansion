...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_VESPIQUEN, CONDITIONS({IF_GENDER, MON_FEMALE})}),
    },
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING),
        .catchRate = 10,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 630 : 188,
        .evYield_Defense = 1,
        .evYield_SpDefense = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TINTED_LENS, ABILITY_NONE, ABILITY_QUEENLY_MAJESTY },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .abilities = { ABILITY_SHARPNESS, ABILITY_SNIPER, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_PURPLE,
