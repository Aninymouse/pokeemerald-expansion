...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_ARMAROUGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_MEGA_LAUNCHER, ABILITY_NONE, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_CERULEDGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_SHARPNESS, ABILITY_NONE, ABILITY_FLASH_FIRE },
    ...
    [SPECIES_GLIMMORA_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Scattering poisonous fragments."),
