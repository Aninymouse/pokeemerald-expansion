...
#define PSY_RS (B_UPDATED_TYPE_MATCHUPS >= GEN_2 ? X(0.5) : X(0.0))  // Ghost      -> Psychic
...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar
    ...
    [TYPE_NORMAL]   = {______, ______, ______, ______, ______, ______, X(0.5), ______, X(0.5), X(0.5), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______},
    [TYPE_FIGHTING] = {______, X(2.0), ______, X(0.5), ______, ______, X(2.0), X(0.5), X(0.5), X(0.5), ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), X(0.5), ______},
    [TYPE_FLYING]   = {______, ______, X(2.0), X(2.0), ______, ______, X(0.5), X(2.0), ______, X(0.5), ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, ______},
    [TYPE_POISON]   = {______, ______, ______, ______, X(0.5), X(0.5), X(0.5), BUG_RS, X(0.0), X(0.5), ______, ______, X(2.0), X(2.0), ______, ______, ______, ______, ______, X(2.0), ______},
    [TYPE_GROUND]   = {______, ______, ______, X(0.0), X(2.0), ______, ______, X(0.5), X(0.5), X(2.0), ______, X(2.0), X(0.5), X(0.5), X(2.0), ______, ______, X(0.5), ______, ______, ______},
    [TYPE_ROCK]     = {______, ______, X(0.5), X(2.0), ______, X(0.5), ______, X(2.0), ______, X(0.5), ______, X(2.0), ______, ______, ______, ______, ______, ______, ______, ______, ______},
    [TYPE_BUG]      = {______, ______, ______, X(0.5), PSN_RS, ______, X(0.5), ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(2.0), ______, ______},
    [TYPE_GHOST]    = {______, X(0.5), ______, ______, X(0.5), ______, ______, ______, X(2.0), STL_RS, ______, ______, ______, ______, ______, PSY_RS, ______, ______, X(0.5), X(2.0), ______},
    [TYPE_STEEL]    = {______, ______, ______, X(0.5), ______, ______, X(2.0), X(2.0), X(0.5), X(0.5), ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, ______, X(2.0), ______},
    ...
    [TYPE_WATER]    = {______, ______, ______, X(0.5), ______, X(2.0), ______, ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), X(2.0), ______, X(0.5), X(0.5), ______, ______, ______},
    [TYPE_GRASS]    = {______, ______, ______, X(0.5), X(0.5), X(2.0), X(2.0), X(0.5), ______, X(0.5), ______, X(0.5), X(2.0), X(0.5), ______, ______, ______, ______, ______, ______, ______},
    [TYPE_ELECTRIC] = {______, ______, ______, X(2.0), ______, X(0.0), X(0.5), ______, ______, X(2.0), ______, ______, X(2.0), X(0.5), X(0.5), ______, X(0.5), ______, ______, ______, ______},
    [TYPE_PSYCHIC]  = {______, ______, X(2.0), ______, X(2.0), ______, ______, X(0.5), X(2.0), ______, ______, ______, ______, X(0.5), ______, X(0.5), ______, ______, X(0.0), ______, ______},
    ...
    [TYPE_DRAGON]   = {______, ______, ______, ______, ______, ______, ______, ______, X(0.5), X(0.5), ______, ______, ______, ______, ______, ______, ______, X(2.0), ______, X(0.0), ______},
    [TYPE_DARK]     = {______, X(2.0), X(0.5), ______, ______, ______, ______, ______, X(0.5), STL_RS, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(0.5), ______},
    [TYPE_FAIRY]    = {______, ______, X(2.0), ______, X(0.5), ______, ______, ______, ______, X(0.5), ______, X(0.5), ______, ______, X(0.5), ______, ______, X(2.0), X(2.0), ______, ______},
