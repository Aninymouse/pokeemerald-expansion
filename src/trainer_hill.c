...
static const u16 sPrizeListRareCandy1[]  = {ITEM_LEVEL_BALL,       ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListLuxuryBall1[] = {ITEM_LURE_BALL,        ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListMaxRevive1[]  = {ITEM_MOON_BALL,        ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListMaxEther1[]   = {ITEM_FRIEND_BALL,      ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListElixir1[]     = {ITEM_LOVE_BALL,        ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListRoar[]        = {ITEM_FAST_BALL,        ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListSludgeBomb[]  = {ITEM_HEAVY_BALL,       ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListToxic[]       = {ITEM_DREAM_BALL,       ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListSunnyDay[]    = {ITEM_FRIEND_BALL,      ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListEarthQuake[]  = {ITEM_MASTER_BALL,      ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};

static const u16 sPrizeListRareCandy2[]  = {ITEM_LEVEL_BALL,       ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListLuxuryBall2[] = {ITEM_LURE_BALL,        ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListMaxRevive2[]  = {ITEM_MOON_BALL,        ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListMaxEther2[]   = {ITEM_FRIEND_BALL,      ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListElixir2[]     = {ITEM_LOVE_BALL,        ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListBrickBreak[]  = {ITEM_FAST_BALL,        ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListTorment[]     = {ITEM_HEAVY_BALL,       ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListSkillSwap[]   = {ITEM_DREAM_BALL,       ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListGigaDrain[]   = {ITEM_FRIEND_BALL,      ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
static const u16 sPrizeListAttract[]     = {ITEM_MASTER_BALL,      ITEM_MAX_ETHER, ITEM_RARE_CANDY, ITEM_MAX_REVIVE, ITEM_EXP_CANDY_XL, ITEM_EXP_CANDY_L};
